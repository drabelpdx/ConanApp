...
#   Mayor.create(name: 'Emanuel', city: cities.first)
  ...
  maps = Map.create([
    { name: 'The Pict Village', description: "The Pict Village", flip_side: 'The Inn', origin: 'Core Game',
    ...
    { name: 'The Ships', description: " The Ships", flip_side: 'The Abandoned Fort', origin: 'Core Game',
    ...
    { name: 'The Abandoned Fort', description: "The Abandoned Fort", flip_side: 'The Ships', origin: 'Core Game',
    ...
    { name: 'The Frozen Battlefield', description: "The Frozen Battleground", flip_side: 'Tundra Forest', origin: 'Nordheim Expansion' },
    { name: 'The Tundra Forest', description: "The Tundra Forest", flip_side: 'Frozen Battleground', origin: 'Nordheim Expansion' },
