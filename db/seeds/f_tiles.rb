...
Tile.create!([
  ...
  { name: 'Captain', description: '',
    ...
    origin: 'Core Game', count: '2', skill_ids: [28, 29], story_ids: [],
  ...
  { name: 'Skuthus', description: '',
    ...
    origin: 'Core Game', count: '2', skill_ids: [32, 33], story_ids: [],
  ...
  { name: 'Thalis', description: '',
    ...
    origin: 'Core Game', count: '1', skill_ids: [24, 28], story_ids: [5],
  ...
  { name: 'Zogar Sag', description: 'Pict Shaman',
    ...
    origin: 'Core Game', count: '2', skill_ids: [33], story_ids: [14],
  ...
  { name: 'Zaporavo', description: '',
    ...
    origin: 'Core Game', count: '2', skill_ids: [16, 28], story_ids: [6],
  ...
  { name: 'Dark Demon', description: '',
    ...
    origin: 'Core Game', count: '2', skill_ids: [10, 26], story_ids: [],
  ...
  { name: 'Giant Snake', description: '',
    ...
    origin: 'Core Game', count: '2', skill_ids: [10, 11], story_ids: [14],
  ...
  { name: 'Khosatral Khel', description: '',
    ...
    origin: 'Core Game', count: '2', skill_ids: [4, 11], story_ids: [10],
  ...
  { name: 'Outer Dark Demon', description: '',
    ...
    melee: '2 Red-Reroll', ranged: '–', bone_ids: [2, 2],
    origin: 'Core Game', count: '2', skill_ids: [12, 18], story_ids: [],
  ...
  { name: 'Thak', description: '',
    role: 'Monster', move: '3', armor: '3',
    melee: '2 Red-Reroll', ranged: '–', bone_ids: [2, 2],
    origin: 'Core Game', count: '2', skill_ids: [10], story_ids: [7],
  ...
  { name: "Bêlit's Guards", description: '',
    ...
    origin: 'Core Game', count: '1', skill_ids: [16, 29], story_ids: [],
  ...
  { name: 'Princess', description: '',
    ...
    melee: '–', ranged: '–', bone_ids: [],
    origin: 'Core Game', count: '1', skill_ids: [], story_ids: [4, 11, 13, 17],
    figure_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/figures/Princess.jpg',
  ...
  { name: 'Bossonian Archers', description: '',
    ...
    origin: 'Core Game', count: '1', skill_ids: [8], story_ids: [2, 14, 16],
  ...
  { name: 'Bossonian Archers - Purple', description: '',
    role: 'Minion', move: '2', armor: '1', cost: '1',
    melee: '–', ranged: '2 Yellow-Reroll', bone_ids: [6, 6],
    origin: 'Core Game', count: '1', skill_ids: [8], story_ids: [],
    figure_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/figures/BossonianArchers.jpg',
  ...
  { name: 'Bossonian Guards', description: '',
    ...
    origin: 'Core Game', count: '1', skill_ids: [29], story_ids: [1, 2, 14, 16],
  ...
  { name: 'Bossonian Guards - Blue', description: '',
    role: 'Minion', move: '2', armor: '2', cost: '1',
    melee: 'Orange, Yellow', ranged: '–', bone_ids: [3, 5],
    origin: 'Core Game', count: '1', skill_ids: [29], story_ids: [],
    figure_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/figures/BossonianGuards.jpg',
  ...
  { name: 'Hyenas', description: '',
    ...
    origin: 'Core Game', count: '2', skill_ids: [12, 16], story_ids: [9, 24],
  ...
  { name: 'Pict Hunters', description: '',
    ...
    origin: 'Core Game', count: '1', skill_ids: [16], story_ids: [1, 14, 20],
  ...
  { name: 'Pict Hunters - Blue', description: '',
    role: 'Minion', move: '2', armor: '1', cost: '1',
    melee: '2 Yellow-Reroll', ranged: '–', bone_ids: [6, 6],
    origin: 'Core Game', count: '1', skill_ids: [16], story_ids: [],
    figure_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/figures/PictHunters.jpg',
  ...
  { name: 'Pict Warriors - Purple', description: '',
    ...
    origin: 'Core Game', count: '1', skill_ids: [10, 16], story_ids: [],
  ...
  { name: 'Pirates', description: '',
    ...
    melee: 'Orange', ranged: '–', bone_ids: [3],
    origin: 'Core Game', count: '1', skill_ids: [13, 16], story_ids: [8, 9, 10, 20],
  ...
  { name: 'Pirates - Blue', description: '',
    role: 'Minion', move: '3', armor: '1', cost: '1',
    melee: 'Orange', ranged: '–', bone_ids: [3],
    origin: 'Core Game', count: '1', skill_ids: [13, 16], story_ids: [],
    figure_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/figures/Pirates.jpg',
  ...
  { name: 'Thog', description: '',
    ...
    melee: '3 Red-Reroll', ranged: '–', bone_ids: [2, 2, 2],
    origin: 'King Pledge', count: '2', skill_ids: [14, 25], story_ids: [5],
  ...
  { name: 'Thog - Alt', description: '',
    role: 'Monster', move: '1', armor: '3',
    melee: '3 Red-Reroll', ranged: '–', bone_ids: [2, 2, 2],
    origin: 'King Pledge', count: '2', skill_ids: [3, 25], story_ids: [],
    figure_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/figures/Thog.jpg',
  ...
  { name: 'Conan’s Lion', description: '',
    ...
    origin: 'King Pledge', count: '1', skill_ids: [16, 17], story_ids: [],
  ...
  { name: 'Zelata’s Wolf', description: '',
    ...
    origin: 'King Pledge', count: '1', skill_ids: [29, 16], story_ids: [16],
    ...
    token_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/tiles/ZelatasWolfToken.png' },

  # Minions
  { name: 'Mummies', description: '',
    role: 'Minion', move: '2', armor: '2', cost: '2',
    melee: '2 Orange', ranged: '–', bone_ids: [3, 3],
    origin: 'King Pledge', count: '1', skill_ids: [26], story_ids: [1, 13, 16],
  ...
  { name: 'Mummies - Blue', description: '',
    role: 'Minion', move: '2', armor: '2', cost: '2',
    melee: '2 Orange', ranged: '–', bone_ids: [3, 3],
    origin: 'King Pledge', count: '1', skill_ids: [26], story_ids: [],
    figure_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/figures/Mummies.jpg',
  ...
  { name: 'Skeletons', description: '',
    role: 'Minion', move: '2', armor: '1', cost: '1',
    melee: 'Orange-Reroll', ranged: '–', bone_ids: [4],
    origin: 'King Pledge', count: '1', skill_ids: [29], story_ids: [16, 17],
  ...
  { name: 'Skeletons - Green', description: '',
    role: 'Minion', move: '2', armor: '1', cost: '1',
    melee: 'Orange-Reroll', ranged: '–', bone_ids: [4],
    origin: 'King Pledge', count: '1', skill_ids: [29], story_ids: [],
    figure_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/figures/Skeletons.jpg',
  ...
  { name: 'Event 3', description: '',
    role: 'Event', move: '–', armor: '–',
    melee: '–', ranged: '–', bone_ids: [],
    origin: 'Stretch Goal', count: '1', skill_ids: [], story_ids: [],
    figure_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/tiles/Event2.png',
    tile_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/tiles/Event2.png',
    token_image: '' },
  ...
  { name: 'Ageera', description: 'Witch Hunter Finder',
    role: 'Leader', move: '3', armor: '2',
    melee: 'Red, Orange', ranged: '–', bone_ids: [1, 3],
    origin: 'Stretch Goal', count: '2', skill_ids: [16, 33], story_ids: [25],
  ...
  { name: 'Akivasha', description: 'Stygian Priestess turned Vampire',
    ...
    origin: 'Stretch Goal', count: '2', skill_ids: [6, 33], story_ids: [16],
  ...
  { name: 'Constantius', description: 'The Falcon',
    role: 'Leader', move: '3', armor: '3',
    melee: 'Red, Orange', ranged: '–', bone_ids: [1, 3],
    origin: 'Stretch Goal', count: '2', skill_ids: [7, 28], story_ids: [12],
  ...
  { name: 'Gitara', description: '',
    ...
    origin: 'Stretch Goal', count: '2', skill_ids: [17, 29], story_ids: [11],
  ...
  { name: 'Hyperborean Primitive', description: '',
    ...
    origin: 'Stretch Goal', count: '2', skill_ids: [26, 33], story_ids: [],
  ...
  { name: 'Khemsa', description: 'A Black Circle Adept',
    role: 'Leader', move: '2', armor: '2',
    melee: '2 Orange', ranged: '–', bone_ids: [3, 3],
    origin: 'Stretch Goal', count: '2', skill_ids: [22, 33], story_ids: [11],
  ...
  { name: 'Natohk', description: 'Stygian Sorceror Thugra Khotan',
    role: 'Leader', move: '3', armor: '2',
    melee: 'Orange, Yellow', ranged: '–', bone_ids: [3, 5],
    origin: 'Stretch Goal', count: '2', skill_ids: [22, 33], story_ids: [4],
  ...
  { name: 'Warlock', description: '',
    role: 'Leader', move: '2', armor: '2',
    melee: 'Orange-Reroll, Orange', ranged: '–', bone_ids: [4, 3],
    origin: 'Stretch Goal', count: '2', skill_ids: [32, 33], story_ids: [],
  ...
  { name: 'Amboola', description: 'A Kushite Commander',
    ...
    melee: '2 Orange-Reroll', ranged: '–', bone_ids: [4, 4],
    origin: 'Stretch Goal', count: '1', skill_ids: [5, 28,], story_ids: [25],
  ...
  { name: 'Balthus', description: 'A scout and a deadeye shot',
    ...
    origin: 'Stretch Goal', count: '1', skill_ids: [8, 9], story_ids: [14],
  ...
  { name: 'Bêlit', description: 'Queen of the Black Coast',
    role: 'Hero', move: '3', armor: '1',
    melee: '2 Orange', ranged: '–', bone_ids: [3, 3],
    origin: 'Stretch Goal', count: '1', skill_ids: [6, 32], story_ids: [9],
  ...
  { name: 'Hadrathus', description: '',
    ...
    origin: 'Stretch Goal', count: '1', skill_ids: [22, 33], story_ids: [16],
  ...
  { name: 'Kerim Shah', description: 'A Turanian Prince',
    ...
    origin: 'Stretch Goal', count: '1', skill_ids: [9, 32], story_ids: [11],
  ...
  { name: "N'Gora", description: '',
    ...
    origin: 'Stretch Goal', count: '1', skill_ids: [8, 29], story_ids: [9],
  ...
  { name: 'Olgerd Vladislav', description: 'The Tiger',
    role: 'Hero', move: '2', armor: '3',
    melee: '2 Red-Reroll', ranged: '–', bone_ids: [2, 2],
    origin: 'Stretch Goal', count: '1', skill_ids: [4, 10], story_ids: [12],
  ...
  { name: 'Pallantides', description: 'Captain of the Black Dragons',
    ...
    origin: 'Stretch Goal', count: '1', skill_ids: [28, 29], story_ids: [1, 16],
  ...
  { name: 'Shevatas', description: '',
    ...
    melee: '–', ranged: '2 Orange', bone_ids: [3, 3],
    origin: 'Stretch Goal', count: '1', skill_ids: [12, 30], story_ids: [4],
  ...
  { name: 'Taurus', description: 'Prince of Thieves',
    role: 'Hero', move: '3', armor: '2',
    melee: 'Orange-Reroll, Orange', ranged: '–', bone_ids: [4, 3],
    origin: 'Stretch Goal', count: '1', skill_ids: [5, 12], story_ids: [3],
  ...
  { name: 'Valeria', description: '',
    role: 'Hero', move: '3', armor: '2',
    melee: '2 Orange-Reroll', ranged: '–', bone_ids: [4, 4],
    origin: 'Stretch Goal', count: '1', skill_ids: [7, 17], story_ids: [17],
  ...
  { name: 'Zelata', description: '',
    ...
    origin: 'Stretch Goal', count: '1', skill_ids: [28, 33], story_ids: [16],
  ...
  { name: 'Camel', description: 'Punch a camel',
    ...
    melee: 'Yellow', ranged: '–', bone_ids: [5],
    origin: 'Stretch Goal', count: '1', skill_ids: [], story_ids: [4, 5, 22],
    ...
    token_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/tiles/CamelToken.png' },

  { name: 'Kothian Archer', description: '',
    role: 'Ally', move: '3', armor: '2',
    melee: '–', ranged: 'Red', bone_ids: [1],
    origin: 'Stretch Goal', count: '1', skill_ids: [8, 9], story_ids: [],
  ...
  { name: 'Slasher', description: 'Balthus’ dog and ally',
    ...
    melee: 'Red, Orange', ranged: '–', bone_ids: [1, 3],
    origin: 'Stretch Goal', count: '1', skill_ids: [12, 29], story_ids: [14],
    ...
    token_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/tiles/SlasherToken.png' },

  # Monsters
  { name: 'Bone Golem', description: '',
    role: 'Monster', move: '3', armor: '2',
    melee: '3 Red', ranged: '–', bone_ids: [1, 1, 1],
    origin: 'Stretch Goal', count: '2', skill_ids: [11, 25], story_ids: [],
  ...
  { name: 'Forest Demon', description: '',
    ...
    origin: 'Stretch Goal', count: '2', skill_ids: [5, 10], story_ids: [],
  ...
  { name: 'Giant Scorpion', description: '',
    role: 'Monster', move: '3', armor: '2',
    melee: '3 Orange', ranged: '–', bone_ids: [3, 3, 3],
    origin: 'Stretch Goal', count: '2', skill_ids: [27], story_ids: [4],
  ...
  { name: 'Giant Spider', description: '',
    ...
    origin: 'Stretch Goal', count: '2', skill_ids: [15, 19], story_ids: [3, 23],
  ...
  { name: 'Gray Man-Ape', description: '',
    ...
    origin: 'Stretch Goal', count: '2', skill_ids: [10, 19], story_ids: [8],
  ...
  { name: 'Swamp Demon', description: '',
    ...
    origin: 'Stretch Goal', count: '2', skill_ids: [25, 26], story_ids: [],
  ...
  { name: 'Thaug', description: '',
    ...
    origin: 'Stretch Goal', count: '2', skill_ids: [25, 33], story_ids: [12],
  ...
  { name: 'Pict Archers', description: '',
    ...
    origin: 'Stretch Goal', count: '1', skill_ids: [16, 30], story_ids: [],
  ...
  { name: 'Pict Warriors', description: '',
    role: 'Minion', move: '2', armor: '2', cost: '2',
    melee: 'Red-Reroll', ranged: '–', bone_ids: [2],
    origin: 'Stretch Goal', count: '1', skill_ids: [10, 16], story_ids: [1, 14, 20],
    figure_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/figures/PictWarriors.jpg',
  ...
  { name: 'Tentacles', description: '',
    ...
    melee: 'Orange-Reroll, Orange', ranged: '–', bone_ids: [4, 3],
    origin: 'Stretch Goal', count: '1', skill_ids: [1, 3], story_ids: [],
  ...
  { name: 'Baal Pteor', description: '',
    ...
    origin: 'Baal Pteor', count: '2', skill_ids: [10, 5], story_ids: [15],
  ...
  { name: 'Black Dragons', description: "King Conan's personal bodyguard",
    ...
    melee: 'Red-Reroll', ranged: '–', bone_ids: [2],
    origin: 'Black Dragons', count: '1', skill_ids: [7, 29], story_ids: [1],
  ...
  { name: 'Crossbowmen', description: '',
    role: 'Minion', move: '2', armor: '1', cost: '2',
    melee: '–', ranged: 'Red', bone_ids: [1],
    origin: 'Crossbowmen', count: '1', skill_ids: [8, 29], story_ids: [],
  ...
  { name: 'Crossbowmen - Green', description: 'An elite troop of sharpshooters',
    ...
    origin: 'Crossbowmen', count: '1', skill_ids: [8, 9], story_ids: [],
    figure_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/figures/Crossbowmen.jpg',
  ...
  { name: 'Demon of the Earth', description: '',
    ...
    origin: 'Demon of the Earth', count: '2', skill_ids: [11, 10], story_ids: [],
  ...
  { name: 'Dragon', description: '',
    ...
    melee: '4 Red-Reroll', ranged: '–', bone_ids: [2, 2, 2, 2],
    origin: 'Dragon', count: '2', skill_ids: [11, 10], story_ids: [17],
  ...
  { name: 'Giant Wolves', description: '',
    ...
    origin: 'Giant Wolves', count: '3', skill_ids: [12, 16], story_ids: [],
    figure_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/figures/ZelataWolf.jpg',
  ...
  { name: 'Sabertooth Tiger', description: '',
    ...
    melee: 'Red, Orange', ranged: '–', bone_ids: [1, 3],
    origin: 'Sabertooth Tiger', count: '2', skill_ids: [16], story_ids: [],
  ...
  { name: 'Afari', description: 'Witch Hunter Warlord',
    role: 'Leader', move: '2', armor: '3',
    melee: '2 Red', ranged: '–', bone_ids: [1, 1],
    origin: 'Kushite Witch Hunters', count: '1', skill_ids: [5, 7], story_ids: [25],
  ...
  { name: 'Ghayoor', description: 'Witch Hunter Bodyguard',
    role: 'Leader', move: '2', armor: '3',
    melee: '2 Orange', ranged: '–', bone_ids: [3, 3],
    origin: 'Kushite Witch Hunters', count: '1', skill_ids: [5, 29], story_ids: [],
  ...
  { name: 'Shubba', description: 'Witch Hunter Sorcerer',
    role: 'Leader', move: '2', armor: '1',
    melee: '2 Yellow', ranged: '–', bone_ids: [5, 5],
    origin: 'Kushite Witch Hunters', count: '1', skill_ids: [22, 33], story_ids: [25],
  ...
  { name: 'Vanir Valkyrie', description: 'Not Red Sonja',
    role: 'Hero', move: '3', armor: '3',
    melee: '3 Orange-Reroll', ranged: '–', bone_ids: [4, 4, 4],
    origin: 'Vanir Valkyrie', count: '2', skill_ids: [5, 12], story_ids: [],
  ...
  { name: 'Salome', description: 'Taramis’ Evil Sister',
    role: 'Leader', move: '2', armor: '1',
    melee: 'Yellow', ranged: '–', bone_ids: [5],
    origin: 'Paolo Parente Box', count: '2', skill_ids: [33, 32], story_ids: [12],
  ...
  { name: 'Atali', description: 'The Frost-Giant’s Daughter',
    ...
    melee: 'Yellow', ranged: '–', bone_ids: [5],
    origin: 'Nordheim Expansion', count: '3', skill_ids: [33], story_ids: [18],
  ...
  { name: 'Yazdigerd', description: '',
    role: 'Leader', move: '2', armor: '2',
    melee: 'Yellow', ranged: '–', bone_ids: [5],
    origin: 'Nordheim Expansion', count: '2', skill_ids: [33], story_ids: [],
    figure_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/figures/Skuthus.jpg',
  ...
  { name: 'Nijgor', description: 'Atali’s Brother',
    ...
    melee: '2 Red', ranged: '–', bone_ids: [1, 1],
    origin: 'Nordheim Expansion', count: '2', skill_ids: [25], story_ids: [],
  ...
  { name: 'Vanir Warriors', description: '',
    role: 'Minion', move: '2', armor: '1', cost: '1',
    melee: '2 Yellow-Reroll', ranged: '–', bone_ids: [6, 6],
    origin: 'Nordheim Expansion', count: '1', skill_ids: [], story_ids: [18],
  ...
  { name: 'Vanir Warriors - Blue', description: '',
    role: 'Minion', move: '2', armor: '1', cost: '1',
    melee: '2 Yellow-Reroll', ranged: '–', bone_ids: [6, 6],
    origin: 'Nordheim Expansion', count: '1', skill_ids: [5], story_ids: [],
    figure_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/figures/VanirWarriors.jpg',
  ...
  { name: 'Vanir Zombies - Green', description: '',
    ...
    melee: 'Orange', ranged: '–', bone_ids: [3],
    origin: 'Nordheim Expansion', count: '1', skill_ids: [3], story_ids: [],
    figure_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/figures/VanirWarriors.jpg',
  ...
  { name: 'Vanir Primitives', description: '',
    role: 'Minion', move: '2', armor: '1', cost: '1',
    melee: '2 Orange', ranged: '–', bone_ids: [3, 3],
    origin: 'Nordheim Expansion', count: '1', skill_ids: [], story_ids: [],
    figure_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/figures/PictHunters.jpg',
  ...
  { name: 'Crows', description: '',
    ...
    melee: 'Yellow', ranged: '–', bone_ids: [5],
    origin: 'Nordheim Expansion', count: '1', skill_ids: [18, 26], story_ids: [],
  ...
  { name: 'Wolves', description: '',
    role: 'Minion', move: '5', armor: '0', cost: '1',
    melee: 'Orange', ranged: '–', bone_ids: [3],
    origin: 'Nordheim Expansion', count: '1', skill_ids: [12, 16], story_ids: [],
    figure_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/figures/ZelataWolf.jpg',
  ...
  { name: 'Aesir Zombies - Purple', description: '',
    ...
    melee: 'Red', ranged: '–', bone_ids: [1],
    origin: 'Nordheim Expansion', count: '1', skill_ids: [7, 10], story_ids: [],
  ...
  { name: 'Aesir Warriors - Red', description: '',
    ...
    melee: 'Orange', ranged: '–', bone_ids: [3],
    origin: 'Nordheim Expansion', count: '1', skill_ids: [12], story_ids: [],
    figure_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/figures/AesirWarriors.jpg',
  ...
  { name: 'Shuang Mian', description: '',
    role: 'Leader', move: '2', armor: '1',
    melee: '2 Orange', ranged: '–', bone_ids: [3, 3],
    origin: 'Khitai Expansion', count: '2', skill_ids: [22, 33], story_ids: [],
  ...
  { name: 'Evil Hound', description: '',
    role: 'Monster', move: '2', armor: '2',
    melee: '2 Red', ranged: '–', bone_ids: [1, 1],
    origin: 'Khitai Expansion', count: '2', skill_ids: [], story_ids: [],
    figure_image: 'https://s3-us-west-2.amazonaws.com/drabelpdx/Conan/figures/DarkDemon.jpg',
  ...
  { name: 'Khitan Guards', description: '',
    role: 'Minion', move: '2', armor: '1', cost: '1',
    melee: '2 Yellow', ranged: '–', bone_ids: [5, 5],
    origin: 'Khitai Expansion', count: '1', skill_ids: [10], story_ids: [],
  ...
  { name: 'Honor Guards', description: '',
    role: 'Minion', move: '2', armor: '2', cost: '2',
    melee: '2 Orange', ranged: '–', bone_ids: [3, 3],
    origin: 'Khitai Expansion', count: '1', skill_ids: [29], story_ids: [],
  ...
  { name: 'Javelin Throwers', description: '',
    ...
    melee: '–', ranged: '2 Orange', bone_ids: [3, 3],
    origin: 'Khitai Expansion', count: '1', skill_ids: [8], story_ids: [],
  ...
  { name: 'Foo Dogs', description: '',
    ...
    melee: '2 Yellow', ranged: '–', bone_ids: [5, 5],
    origin: 'Khitai Expansion', count: '2', skill_ids: [7], story_ids: [],
  ...
  { name: 'Thoth-Amon', description: '',
    role: 'Leader', move: '2', armor: '1',
    melee: '2 Orange', ranged: '–', bone_ids: [3, 3],
    origin: 'Stygia Expansion', count: '2', skill_ids: [33], story_ids: [1, 16],
  ...
  { name: 'Scorpion Broodmother', description: '',
    ...
    origin: 'Stygia Expansion', count: '2', skill_ids: [10], story_ids: [4],
  ...
  { name: 'Giant Scorpions', description: '',
    ...
    melee: 'Yellow', ranged: '–', bone_ids: [5],
    origin: 'Stygia Expansion', count: '3', skill_ids: [27], story_ids: [4],
  ...
  { name: 'Eternal Guard', description: '',
    role: 'Minion', move: '2', armor: '2', cost: '1',
    melee: 'Red, Orange', ranged: '–', bone_ids: [1, 3],
    origin: 'Stygia Expansion', count: '2', skill_ids: [], story_ids: [],
  ...
  { name: 'Unknown Monster', description: '',
    ...
    melee: '-', ranged: '–', bone_ids: [],
    origin: 'None', count: '1', skill_ids: [], story_ids: [],
