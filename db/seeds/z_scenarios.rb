...
#   Mayor.create(name: 'Emanuel', city: cities.first)
  ...
  scenarios = Scenario.create([
    { name: "In the Clutches of the Picts", description: "<p>With the echoing war
      drums of the Pict tribes settled beyond the Black River and the increased
      frequency of incursions up to the Thunder River, many settlers flee the
      Conajohara territory for the safer lands of the Kingdom of Aquilonia.</p>
      ...
      Back in Fort Tuscelan, Conan assembles a small group of experienced warriors
      to rescue the governor’s daughter and, at Valannus’ request, bring back the
      head of Zogar Sag.</p>",
    ...
    { name: "Hunting the Tigress", description: "<p>For months, the pirate ship
      Tigress has been scouring the waters off the coasts of Stygia and the Black
      Kingdoms and preying on the profitable trade of gold and ivory, much to the
      ...
      handful of remaining warriors can come to Bêlit’s aid.</p>",
      ...
      The other heroes start in the 1 area.</p>
      <strong>Suggestions for 3 heroes:</strong>
      ...
      the character remains in its area.
      If a minion or ally fails to <a class="skill" href="/skills/16">Leap</a>,
    ...
    { name: "The Final Ritual", description: "<p>The province of Conajohara is
      being sacked. United clans of Picts have crossed the Black River in massive
      numbers, intent on slaughtering Aquilonian settlers and annihilating Fort
      Tuscelan. At the head of the invading forces is the shaman Zogar Sag.</p>
      ...
      overlord_setup: 'The game starts with the Overlord’s turn. The heroes start
      in the areas indicated by the setup diagram.
      ...
      <table class="scen_table">
        <tr>
          ...
          <td>
            ...
            symbol shown on a die, the hero moves the invocation marker 1 space
            toward the space 0 on the track.
          </td>
        </tr>
      </table>',
    ...
    { name: "For All of Ophir’s Gold", description: "<p>While visiting the South
      of the kingdom, Princess Olivia, daughter of King Ophir, is set upon by
      Kothian soldiers. The detachment assigned to protect her is massacred.
      After reaping a bloody harvest, even Conan succumbs to the overwhelming
      numbers and the fury of a strange man-ape.</p>
      <p>Now Conan and Olivia are prisoners of Captain Arbanus, right hand of King
      Strabonus of Koth. In his quest to control the gold mines which feed King
      Ophir’s wealth, Strabonus has turned to kidnapping and extortion over costly
      military action. Conan paces in his cell like a caged lion. His incandescent
      blue eyes search for any means of escape, and he rages at his failure to
      protect the princess.</p>
      <p>The Kothians have fallen back to an old fortification on the border of
      the two kingdoms. As they take defensive positions and install deadly
      ...
      hero_goal: "If a hero has fled the fort with Olivia, she is free from Strabonus’
      grasp; the heroes win the game.",
    ...
    { name: "The Wrath of Anu", description: "<p>Two audacious thieves, a deserter
      from Gunderland and a Cimmerian Barbarian, have forged a reputation among
      the city-states of Corinth by stealing riches and plundering caravans on
      the Road of Kings.</p>
    ...
    { name: "Infernal Pursuit Part I", description: "<p>Smelling a trap during a
      ...
      Captain Zaporavo and the crew of The Vandal. Soon, his personality and
      sailing prowess make him popular with the crew,and his leadership gains
      him the attention of Sancha, the Zingaran mercenary’s favorite.</p>
    ...
    { name: "Infernal Pursuit Part II", description: "<p><strong>This scenario
      ...
      that is off the board into a numbered area on the board as indicated by the
      setup diagram 1 2 3 . Turn each green and blue Pirates tile in the River
      faceup, then place each green and blue Pirates tile that is not in the River
      ...
      hero_goal: "If Zaporavo dies or the turn marker reaches space 8, The Vandal
    ...
    { name: "Trapped like Rats", description: "<p>Laughs and shouts ring out as
      ...
      spending the remainder of the pay from their time in the army of Ophir’s
      kingdom.</p>
      ...
      <br /><br />After setup, each hero moves 3 gems from their Reserve zone to
      their Fatigue zone.',
    ...
    { name: "Red Dawn", description: "<p>The situation is dire. The Aquilonian
      province of Conajohara is on the brink of collapse, drowned under the
      assault of the unified Pict tribes led by Zogar Sag. For days, Conan and
      his band of scouts have prowled the Black River, fighting fiercely to
      protect the settlers fleeing the destruction.</p>
    ...
    { name: "The Key of Kuthchemes", description: "<p>The rumor spreads quickly
      amongst the thieves of Asgalun: The Vandal has made port in Pelishtim and
      its captain, Zaporavo, has found a copy of the texts of Vathelos the Blind.
      Legends tell that the texts contain secrets to opening the doors to the
      shimmering dome that looms above the ancient ruins of Kuthchemes in the
      vast deserts of south-western Shem.</p>
      ...
      (<a class="item" href="/items/15">Kris</a>,
        <a class="item" href="/items/14">Throwing Knives</a>),
      <br /><br />After setup, heroes do not move any gems from their Reserve
      zone to their Fatigue zone.',
    ...
    { name: "In the Name of Ibis", description: "<p>The hunt nears its end; on
      the limits of the kingdom of Nemedia, Conan picks up the trail of Skuthus,
      the sorcerer he has pursued relentlessly since Numalia.</p>
    ...
    { name: "The Crawling Shadow", description: "<p>Relentlessly pursued and having
      finally reached the Black Kingdom of Kush, the survivors of the felon prince
      Almuric’s army are finally annihilated in the northern desert when the jaws
      of the Stygian and Kushite warriors close on them.</p>
      ...
      <p>Thalis lavishes attention upon Conan, who obstinately refuses her advances.
      Seeing a rival in Valeria, she captures the warrior, planning to offer her
      as a sacrifice to Thog, the city’s god.</p>",
      ...
      <br /><br />After setup, Valeria moves 4 gems from her Reserve zone to her
      Fatigue zone; Conan and Shevatas do not move any gems.',
    ...
    { name: "Conspiracy in Khauran", description: "<p>Khauran is a small country,
      wedged between the great Western states and the sultanates of the Far East.
      Its major city—also called Khauran—is an affluent trade center that controls
      many caravan routes. Like a watchtower, it stands near the river that separates
      the lush regions from the vast, sandy desert.</p>
    ...
    { name: "Yogah’s Rebirth", description: "<p>The steep walls of the ancient
      fortress obscure the bottom of the valley. There, in the confines of the
      world known to Hyborians, where the legends surrounding the Black Kingdoms
      are born, a small group of intrepid adventurers dares to brave the dense
      vegetation that seems to be protecting the dark forgotten edifice.</p>
      <p>Yag-Kosha guides his companions through this vegetal maze. The terrifying,
      yet peaceful extraterrestrial is searching for the magical gem that once
      belonged to his people, containing a world in which he can be reincarnated
      as Yogah of Yag.</p>
      ...
      (<a class="item" href="/items/12">Ornamental Spear</a>,
        ...
        <a class="spell" href="/spells/8">Mitra’s Healing</a>),
      <br /><br />After setup, each hero moves 6 gems from their Reserve zone to
      their Fatigue zone.',
    ...
    { name: "Yara’s Trap", description: "<p>Yag-Kosha has escaped from centuries
      of captivity and torture in the hands of the mad sorcerer known as Yara,
      a devil in human form and the terror of the kingdom of Zamora. The peaceful
      alien is now looking for a magical gem that once belonged to his people,
      a jewel of crimson crystal called the Heart of the Elephant. Thanks to this
      fabulous gem and the world it contains, he can be reincar- nated as Yogah
      of Yag and end his days in peace as the last representative of his kind.</p>
      ...
      (<a class="item" href="/items/8">Halberd</a>,
        <a class="spell" href="/spells/14">Set’s Possession</a>,
        <a class="spell" href="/spells/8">Mitra’s Healing</a>),
      <br /><br />After setup, Yogah of Yag does not move any gems from his
      Reserve zone to his Fatigue zone.
      The hero plays their stance phase as if one hero had died during the game.
      They move 3 gems from their Fatigue zone to their Reserve zone when they
      choose an aggressive stance and 6 gems when the hero is cautious.',
    ...
    { name: "The Cursed Mirrors", description: "<p>The Queen of the Black Coast
      ...
      to be the right choice. Standing there, in front of the ruins of a forgotten
      thousand-year-old building, engulfed by the lush vegetation, she has no
      regrets accepting the small fortune that the priest has given her to be
      escorted to the wild shores of the Kush kingdom. Not knowing how to control
      her greed, the Shemite devil, surrounded by a handful of her black buccaneers,
      has followed the priest through the sinister jungle in the hope of discovering
      a much more impressive bounty; she has the feeling that Hadrathus is pursuing
      relics of immea- surable value.</p>
      ...
      overlord_goal: "f the Overlord destroys the three artifacts before the end
    ...
    { name: "The Zamboula Strangler", description: "<p>In the past Zamboula was
      but a small trading-town, lying amidst a ring of oases. It was conquered
      by the Stygians and they built it into a city; the ceaseless caravans
      crossing the Kharamun desert brought it riches. Then Turanian invaders
      galloped out of the East to thrust back the boundaries of Stygia.</p>
    ...
    { name: "Where the Thunder Rumbles", description: "<p>Conan and his men have
      journeyed for several hours from Velitrium, the raw, turbulent frontier
      town situated on the banks of Thun- der River. There, on the western border
      of the kingdom of Aquilonia, the Cimmerian thinks back to the time of the
      end of Conajohara. This province was slowly conquered from wild Pictish
      territory, whose people were pushed back beyond the Black River in a
      succession of bloody massacres.</p>
      ...
      (<a class="item" href="/items/9">Bossonian Bow</a> and
        <a class="item" href="/items/11">Parrying Dagger</a>) and Slasher.
      <br /><br />After setup, each hero moves 3 gems from their Reserve zone to
      their Fatigue zone.',
    ...
    { name: "Sacrificial Heroes", description: "<p>Zingara is a proud and powerful
      country, bordering the great western sea. Yet for many years, even though
      the country is endowed with fertile land, the king and his ancestors before
      him have had their eyes riveted on the rich country of Poitain situated on
      the other side of the river Alimane. This province, owned by Aquilonia,
      is geographically separated from the rest of their kingdom by a chain of
      mountains in the North, whereas only the Alimane  separates it from Zingara.</p>
      <p>Although he hesitates in declaring open war, the envious monarch has
      decided to test the defenses and the resistance of the province by organizing
      a raid led by a company of mercenaries. What better than to entrust the
      command to a renegade seeking redemption. Captain Zaporavo, a former
      buccaneer, will make the perfect sacrificial hero without the risk of
      officially incriminating Zingara.</p>
      ...
      (<a class="item" href="/items/35">Pirate Saber</a>) and 2 Pirates.
      <br /><br />After setup, each hero moves 5 gems from their Reserve zone to
      their Fatigue zone.',
      ...
      rulefour_text: 'Skuthus can only reinforce Pirates. He cannot reinforce
      Pict Warriors.',
      rulefive_title: "Pict Warriors:",
      rulefive_text: 'Only Zogar Sag can use Leadership to activate and defend
      the Pict Warriors.',
      ...
      The maps are considered as stolen after a hero with the Spellbook card has
      fled the citadel.
      As soon as the maps are stolen, and for the rest of the game, the number
      of necessary successes to destroy a hut is reduced to 4.',
      ...
      ruleseventeen_text: 'A character must spend 1 extra movement point to move
      out of the pit area.',
    ...
    { name: "A Dragon on the Marches", description: "<p>The rumor was true. The
      Pict warriors of the Eagle Clan have succeeded in capturing a dragon; one
      of the terrible primitive creatures that still haunt the immense and ancient
      forests that border the western coast of the Thurian continent.</p>
      ...
      hero_goal: "If the heroes kill the Dragon before the end of turn 7; the
      heroes win the game.",
      hero_setup: 'The game starts with the heroes’ turn.
      <br /><br /><strong>Suggestions for 3 heroes:</strong>
      ...
      (<a class="item" href="/items/43">Black Staff</a>,
        ...
        <a class="spell" href="/spells/33">Eel Skin</a>).
      <br /><br />After setup, each hero moves 5 gems from their Reserve zone
      to their Fatigue zone.',
    ...
    { name: "Death from the North", description: "<p>The keen eye of the imposing
      figure scrutinizes every corner of the peaceful Brythunian village. Hidden
      at the edge of the forest by the dense foliage, the man formulates his plan
      of attack while recalling the painful circumstances that have led him so far.</p>
      ...
      (<a class="item" href="/items/21">Tribal Shield</a>).
      <br /><br />After setup, each hero moves 6 gems from their Reserve zone
      to their Fatigue zone.',
    ...
    { name: "The Terrible Lovers", description: "<p>The pirate ship, The Tigress,
      ...
      After a fruitful campaign of bloody robbery and violent pillaging against
      the Stygian ships; Bêlit, a fiery Shemite captain, and Conan, her lieutenant
      and lover from the dismal hills of Cimmeria, have decided to have a good time
      squandering the booty that they have forcefully amassed.</p>
      ...
      <a class="item" href="/items/14">Short Sword</a>).
      <br /><br />After setup, each hero moves 4 gems from their Reserve zone
      to their Fatigue zone.',
      ...
      on a reinforcement token’s area. The orb explodes normally and that ship
      sinks. When a ship is sunk, the Overlord removes from the river the event
    ...
    { name: "The Curse of the Shape-Shifter", description: "<p><Bahram, the
      influential sorcerer in the service of the Sultan of Iranistan, has lost
      control of his powers. He has become a shape-shifter against his own will
      and no one knows whether this is a punishment from the gods or a curse
      picked up from his excessive studies of impious mysteries. As the evil
      continues to worsen, and in fear of losing his human envelope once and for
      all, the sorcerer has started a complex and dangerous ritual in order to
      lift this curse. The Sultan, on the other hand, does not wish to run any
      risks and has sent Prince Kerim Shah to solve the problem at his discretion;
      Bahram has become a danger to the ruling family and the people around him.</p>
      ...
      same time as the activated unit. The pirate makes the same move (or part of
        the move) as the Overlord unit. If the Overlord uses a Movement benefit
        for the activated unit, the pirate can follow the unit without the
    ...
    { name: "The White Witch", description: "<p>Far from the disturbing ancestral
      lands occupied by the Pict people, there is a cursed place that the fierce
      painted warriors avoid. The territory of a solitary witch living among
      wolves. An Aquilonian who had long been exiled and turned towards the
      children of wild nature rather than towards men. Yet Zelata, for such is
      her name, is not a disciple of black magic; and if she does not seek quarrel
      with the neighboring Pict clans, they nevertheless vow a superstitious fear
      to her. She is the White Witch coming from the East, who speaks to nature
      and animals as well as to spirits.</p>
      ...
      hero_goal: "If Zelata kills the Swamp Demon before the end of round 6, the
      hero wins the game.",
      hero_setup: 'The game starts with the hero’s turn.
      <br /><br /><strong>Suggestions for 1 hero:</strong>
      ...
      (2 spells: <a class="spell" href="/spells/7">Mitra’s Halo</a> and
        ...
        Zelata starts with Mitra’s Halo cast.
      <br /><br />After setup, the hero moves no gems from their Reserve zone to
      their Fatigue zone.',
    ...
    { name: "A Lion Among Panthers", description: "<p>The man with the broad
      shoulders grimaces protruding his muscles so as to break the ties that
      hinder him. His clothes are of quality, but of simple craftsmanship and he
      does not wear rings, or finery to the exception of a silver headband which
      encircles his head, holding his black square-cut mane. No Pict would be
      able to recognize in him the King of Aquilonia. Still, it is Conan, trying
      to escape the ferocious warriors of the Panther clan, who treacherously
      captured him the day before.</p>
      ...
      <br /><a class="hero" href="/heroes/10">Balthus</a>
      (<a class="item" href="/items/16">Leather Armor</a>) with Slasher
      <br /><br />After setup, the heroes moves no gems from their Reserve zone
      to their Fatigue zone.',
      ...
      { name: "The Price of Success", description: "<p>Captain Zaporavo exults!
        He, the mercenary hired by the king of Zingara, succeeded in capturing
        a general of the Aquilonian army. Constantly fomenting upheavals in the
        province of Poitain, so as to engender a diplomatic incident with the
        powerful Aquilonia; Zaporavo succeeded in worrying King Numedides. The
        latter knows all too well that Zingara has been trying for a long time
        to win over him the control of this rich region, without daring to launch
        into an open war.</p>
        ...
        <a class="item" href="/items/56">Cape</a>) with
          ...
          <a class="tile" href="/tiles/33">Pirates</a>
        <br /><br />After setup, the heroes moves no gems from their Reserve zone
        to their Fatigue zone.',
