...
#   Mayor.create(name: 'Emanuel', city: cities.first)
  ...
  heroes = Hero.create([
    { name: 'Belit', description: "Bêlit turned toward Conan, her bosom heaving, her eyes flashing.
      ...
      Her rich black hair, black as a Stygian night, fell in rippling burnished clusters down her supple back. Her dark eyes burned on the Cimmerian. Robert E. Howard – Queen of the Black Coast",
      ...
      defense_dice: 'Yellow',
      origin: 'Core', skill_ids: [6, 13, 16, 21, 28] },
    { name: 'Conan', description: 'Our hero',
      ...
      manipulation_dice: 'Orange', manipulation_exersion: '3',
      defense_dice: 'Orange',
      origin: 'Core', skill_ids: [4, 11, 13, 16, 19] },
    { name: 'Hadrathus', description: 'Alcolyte',
      ...
      manipulation_dice: 'Orange', manipulation_exersion: '3',
      defense_dice: 'Orange',
      origin: 'Core', skill_ids: [16, 22, 33] },
    { name: 'Shevatas', description: 'King of Thieves',
      ...
      defense_dice: 'Orange',
      origin: 'Core', skill_ids: [12, 16, 19, 23, 30] },
    { name: 'Amara The Lion', description: 'none',
      ...
      manipulation_dice: 'Orange', manipulation_exersion: '3',
      defense_dice: 'Orange',
      origin: 'King', skill_ids: [7, 13, 16, 21, 22] },
    { name: "N'Gora", description: "Belit's Second",
      ...
      defense_dice: 'Orange',
      origin: 'King', skill_ids: [8, 13, 16, 19, 31] },
    ...
    { name: 'Zelata', description: 'The Witch',
      ...
      manipulation_dice: 'Orange', manipulation_exersion: '3',
      defense_dice: 'Yellow',
      origin: 'King', skill_ids: [16, 20, 21, 22, 28, 33] },
    { name: 'Amboola', description: 'none',
      life: '10', encumberance: '10',
      melee_dice: 'Orange', melee_exertion: '5',
      ...
      manipulation_dice: 'Orange', manipulation_exersion: '3',
      defense_dice: 'Orange',
      origin: 'Stretch', skill_ids: [5, 13, 16, 21] },
    { name: 'Balthus', description: 'none',
      life: '10', encumberance: '10',
      melee_dice: 'Orange', melee_exertion: '4',
      ...
      defense_dice: 'Orange',
      origin: 'Stretch', skill_ids: [8, 9, 13, 16, 17, 21] },
    { name: 'Conan - General', description: 'none',
      life: '11', encumberance: '12',
      ...
      manipulation_dice: 'Orange', manipulation_exersion: '3',
      defense_dice: 'Orange',
      origin: 'Stretch', skill_ids: [11, 13, 16, 19, 21] },
    { name: 'Conan - Mercenary', description: 'none',
      life: '11', encumberance: '12',
      melee_dice: 'Red', melee_exertion: '5',
      range_dice: 'Orange', range_exertion: '4',
      movement_free: '2', movement_exertion: '4',
      manipulation_dice: 'Orange', manipulation_exersion: '3',
      defense_dice: 'Orange',
      origin: 'Stretch', skill_ids: [2, 7, 13, 16, 19] },
    { name: 'Conan - Wanderer', description: 'none',
      life: '11', encumberance: '12',
      melee_dice: 'Red', melee_exertion: '4',
      range_dice: 'Orange', range_exertion: '4',
      movement_free: '3', movement_exertion: '4',
      manipulation_dice: 'Orange', manipulation_exersion: '3',
      defense_dice: 'Orange',
      origin: 'Stretch', skill_ids: [4, 11, 13, 16, 19] },
    { name: 'Conan - Warlord', description: 'none',
      life: '11', encumberance: '12',
      ...
      manipulation_dice: 'Orange', manipulation_exersion: '3',
      defense_dice: 'Orange',
      origin: 'Stretch', skill_ids: [4, 13, 16, 19, 22] },
    { name: 'Kerim Shah', description: 'none',
      life: '10', encumberance: '10',
      melee_dice: 'Orange', melee_exertion: '4',
      range_dice: 'Orange', range_exertion: '5',
      movement_free: '2', movement_exertion: '4',
      ...
      defense_dice: 'Orange',
      origin: 'Stretch', skill_ids: [9, 16, 19, 22, 30] },
    { name: 'Olgerd Vladislav', description: 'Companions',
      ...
      defense_dice: 'Orange',
      origin: 'Stretch', skill_ids: [4, 9, 16, 31] },
    { name: 'Pallantides', description: 'Black Dragons Commander',
      ...
      defense_dice: 'Orange',
      origin: 'Stretch', skill_ids: [9, 16, 21, 29, 31] },
    { name: 'Pelias', description: 'none',
      ...
      origin: 'Stretch', skill_ids: [6, 21, 22, 26, 33] },
    { name: 'Savage Belit', description: 'Fighting Belit',
      ...
      manipulation_dice: 'Orange', manipulation_exersion: '4',
      defense_dice: 'Yellow',
      origin: 'Stretch', skill_ids: [2, 6, 12, 13, 16] },
    { name: 'Taurus', description: 'Master Thief',
      ...
      defense_dice: 'Orange',
      origin: 'Stretch', skill_ids: [5, 16, 17, 19, 23] },
    { name: 'Constantius', description: 'none',
      life: '11', encumberance: '12',
      ...
      manipulation_dice: 'Yellow', manipulation_exersion: '3',
      defense_dice: 'Orange',
      origin: 'Villain', skill_ids: [4, 7, 28, 31] },
    { name: 'Skuthus', description: 'none',
      life: '10', encumberance: '10',
      melee_dice: 'Yellow', melee_exertion: '4',
      range_dice: 'Yellow', range_exertion: '3',
      movement_free: '2', movement_exertion: '4',
      manipulation_dice: 'Orange', manipulation_exersion: '3',
      defense_dice: 'Yellow',
      origin: 'Villain', skill_ids: [6, 22, 33] },
    { name: 'Thak', description: 'none',
      ...
      manipulation_dice: 'Yellow', manipulation_exersion: '3',
      defense_dice: 'Yellow-Reroll',
      origin: 'Villain', skill_ids: [2, 13, 16, 19] },
    { name: 'Zaporavo', description: 'none',
      ...
      manipulation_dice: 'Orange', manipulation_exersion: '3',
      defense_dice: 'Orange',
      origin: 'Villain', skill_ids: [5, 7, 16, 21, 32] },
    { name: 'Zogar Sag', description: 'none',
      life: '10', encumberance: '8',
      melee_dice: 'Orange', melee_exertion: '4',
      range_dice: 'Yellow', range_exertion: '4',
      movement_free: '3', movement_exertion: '4',
      manipulation_dice: 'Orange', manipulation_exersion: '3',
      defense_dice: 'Orange',
      origin: 'Villain', skill_ids: [12, 21, 32, 33] },
    { name: 'Valkyrie Vanir', description: 'none',
      life: '10', encumberance: '10',
      melee_dice: 'Orange-Reroll', melee_exertion: '4',
      range_dice: 'Orange', range_exertion: '3',
      movement_free: '3', movement_exertion: '3',
      ...
      defense_dice: 'Orange',
      origin: 'Add On', skill_ids: [2, 5, 12, 16, 31] },
    { name: 'Niord ', description: 'none',
      life: '11', encumberance: '12',
      melee_dice: 'Orange', melee_exertion: '5',
      range_dice: 'Yellow', range_exertion: '4',
      movement_free: '2', movement_exertion: '4',
      manipulation_dice: 'Yellow', manipulation_exersion: '3',
      defense_dice: 'Red',
      origin: 'Nordheim', skill_ids: [2, 10, 16, 19, 21] }
  ])

  tiles = Tile.create([
    { name: 'Sculthus', description: 'Sculthus',
      role: 'Leader', color: 'neutral',
      move: '2', armor: '1', melee_dice: 'Yellow', range_dice: 'na',
      origin: 'Core', count: '2' },
    { name: 'Pirates', description: 'Pirates',
      role: 'Minion', color: 'Green',
      move: '3', armor: '1', melee_dice: 'Orange', range_dice: 'na',
      origin: 'Core', count: '1' }
  ])
